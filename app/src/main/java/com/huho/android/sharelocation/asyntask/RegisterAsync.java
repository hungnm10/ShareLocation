...
/**
 * Created by hung.nq1 on 3/5/2016.
 */
public class RegisterAsync extends AsyncTask<String, Void, String> {
    ...
    public RegisterAsync(ProgressHUD aHud, FragmentManager aManger, IAsynTaskDelegate anInterface) {
        this.hud = aHud;
    ...
    protected String doInBackground(String... params) {
        ...
        String result = CoreService.getInstance().sendRegister(email, pass, name);
        return result;
    }
