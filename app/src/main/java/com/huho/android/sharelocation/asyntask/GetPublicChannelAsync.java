 ...
 */
public class GetPublicChannelAsync extends AsyncTask<String, Void, String> {
    ...
    public GetPublicChannelAsync(ProgressHUD aHud, FragmentManager aManger,
    ...
    protected String doInBackground(String... params) {
        String result = CoreService.getInstance().getGetPublicChannel();
        return result;
    }
            ...
            try {
                if (obj == null) {
                    ...
                    if (obj.getInt("success") == 1) {
                        this.interfa.didSuccessWithJsonArray(obj.getJSONArray("channels"));
                    } else {
