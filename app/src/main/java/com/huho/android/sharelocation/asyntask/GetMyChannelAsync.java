 ...
 */
public class GetMyChannelAsync extends AsyncTask<String,Void,String> {
    private IAsynTaskDelegate interfa;
    private ProgressHUD hud;
    private FragmentManager fManager;

    public GetMyChannelAsync(ProgressHUD aHud, FragmentManager aManger,
    ...
    protected String doInBackground(String... params) {
        String result = CoreService.getInstance().getMyChannel();
        return result;
    }
    @Override
